...
$listAllPlayer = $formUser->select_dolusers($player_all, 'player_all', 1,0,'','','','0',0,0,'',0,'','',1);
$listAllWinner = $formUser->select_dolusers($winner_all, 'winner_all', 1, 0, '', '', '', '0', 0, 0, '', 0, '', '', 1);
$listAllLooser = $formUser->select_dolusers($looser_all, 'looser_all', 1, 0, '', '', '', '0', 0, 0, '', 0, '', '', 1);
